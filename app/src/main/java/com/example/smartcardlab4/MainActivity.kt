        ...
        whatsapp_id.setOnClickListener {
            startActivity(
                Intent(
                    Intent.ACTION_VIEW,
                    Uri.parse(
                        "https://api.whatsapp.com/send?phone=+8801780427696&text=Hello Yumna Tasneem"
                    )
                )
            )
        }
